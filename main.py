...
def get_custom_prompt():
    ...
    personas = {
        ...
        'Expert': """You are an expert consultant with deep knowledge across multiple fields.
                    ...
                    User: {input}
                    Expert:""",
        'Creative': """You are a creative and imaginative AI that thinks out of the box.
...
def main():
    ...
    with st.sidebar:
        ...
        model = st.selectbox(
            'Choose your model:', ['mixtral-8x7b-32768', 'llama3-70b-8192'],
        ...
        memory_length = st.slider(
            'Conversation Memory (Messages)', 1, 10, 5,
        ...
        st.session_state.selected_persona = st.selectbox(
            'Select conversation style:', ['Default', 'Expert', 'Creative']
        )
